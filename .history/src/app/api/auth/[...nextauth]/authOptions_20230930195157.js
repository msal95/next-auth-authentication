...
export const authOptions = {
  ...
  callbacks: {
    ...
    async jwt({ token, user }) {
      console.log("🚀 ~ file: authOptions.js:43 ~ jwt ~ user:", user);
      if (user) {
    ...
    async session({ session, user, token }) {
      console.log("🚀 ~ file: authOptions.js:53 ~ session ~ token:", token);
      console.log("🚀 ~ file: authOptions.js:53 ~ session ~ user:", user);
