...
export default function Signup() {
  ...
  const handleSubmit = () => {
    axios.post("/api/register", authState).then((res)=>{
      const response = res.data

      if(response.status === 200){
        console.log("🚀 ~ file: page.js:21 ~ axios.post ~ response:", response)
        
      }else{
        console.log("🚀 ~ file: page.js:24 ~ axios.post ~ response.error:", response.error);
      }
    }).catch(error){
